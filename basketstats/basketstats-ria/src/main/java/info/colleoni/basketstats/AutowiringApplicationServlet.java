 ...
 * {@link Application} objects it creates using the associated Spring
 * {@link WebApplicationContext}. This allows a Vaadin application to be
 * configured normally as a Spring bean.
 * 
 * <p>
 ...
 * ContextLoaderListener}: <blockquote>
 * 
 * <pre>
...
public class AutowiringApplicationServlet extends ApplicationServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8620245353056259577L;
	...
	public void init(ServletConfig config) throws ServletException {
		...
		try {
			...
			throw new ServletException(
					"could not locate containing WebApplicationContext");
		}
	}
	...
	protected final WebApplicationContext getWebApplicationContext()
		...
		if (this.webApplicationContext == null)
			throw new ServletException(
					"can't retrieve WebApplicationContext before init() is invoked");
	...
	protected final AutowireCapableBeanFactory getAutowireCapableBeanFactory()
		...
		try {
			...
			throw new ServletException("containing context "
					+ getWebApplicationContext() + " is not autowire-capable",
					e);
		}
	}
	...
	protected Application getNewApplication(HttpServletRequest request)
		...
		try {
			...
			try {
				...
				throw new ServletException("failed to create new instance of "
						+ cl, e);
			}
		} catch (ClassNotFoundException e1) {
			throw new ServletException("failed to get Application class", e1);
		}
	}
}
